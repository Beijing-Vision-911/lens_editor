...
class Minimap:
    ...
    def draw(self,defect):
        ...
        cv2.circle(self.background,(defect.xmin, defect.ymin),20, (255,0,0))
        cv2.circle(self.background, (x, y), 25, 255,0,0, 3)        #x,y用来画圈，x_t,y_t,用来画缩略图
    ...
    #     return numpy2pixmap(self.background)
