...
"""
    ...
    def add_uncretain(self):
        self.uncretain = UncertainEditWindow(self.main_window)
        self.uncretain.show()
    ...
    def run_rule(self):
        ...
        for g in good:
            ...
            if un_failed:
                ...
                # g_layout.addItem(LensWidget(g.xml_path, un_failed, Qt.yellow))
        print("不确定==", b)
        print("合格==", len(helist))
        print(sorted(helist))
...
"""
        if hasattr(self.main_window, "un_rule_set_str"):
            ...
            return
        self.main_window.un_rule_set_str = uncertain_default
        self.un_text_edit.setText(uncertain_default)
